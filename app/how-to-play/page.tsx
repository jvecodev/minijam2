...
export default function HowToPlay() {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-900 to-black p-8">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        <div className="text-left space-y-4 mb-8">
          <div>
            ...
            <p className="text-gray-200">
              • Pressione <span className="bg-gray-700 px-2 py-1 rounded">Espaço</span> para pular sobre obstáculos.
            </p>
            <p className="text-gray-200">
              • Pressione <span className="bg-gray-700 px-2 py-1 rounded">ESC</span> para pausar o jogo.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-200">
              Corra pelos anéis de Saturno o máximo que puder, evitando obstáculos e coletando itens. A cada nível, a
              dificuldade aumenta!
            </p>
          </div>
